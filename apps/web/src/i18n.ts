...
const EN = {
  ...
  acceptOwnEmailHint: 'This is how you will sign in, and where a password reset would go.',
  fullName: 'Full name',
  inviteByLink: 'Create a link instead',
  inviteByLinkHelp:
    'A link with no address on it, for sending by hand. Whoever opens it gives their own name and email. It works once, so send it to one person.',
  inviteLinkCreated: 'Invitation link created',
  inviteLinkNote:
    'It can be used once, by whoever opens it first. Send it to one person, not a group.',
  ...
  passwordMinLength: 'Use at least {n} characters.',
  ...
  usageTitle: 'Usage',
  usageIntro: 'Who has an account, who is coming back, and where people get stuck.',
  usageActiveAccounts: 'active accounts',
  usageSignedIn7d: 'signed in this week',
  usagePendingInvites: 'invitations not accepted',
  usageNeverSignedIn: 'never signed in',
  usageLastFortnight: 'Sign-ins, last two weeks',
  usagePeople: 'People',
  usageName: 'Person',
  usageLastSeen: 'Last signed in',
  usageLastActive: 'Last active',
  usageSignIns30d: 'Sign-ins',
  usageSearches30d: 'Searches',
  usageViews30d: 'Opened',
  usageEmptySearches30d: 'Found nothing',
  usageTrouble: 'Trouble',
  usageDevice: 'Device',
  usageLast30d: 'Last 30 days',
  usageFailedSignIns: '{n} failed sign-ins',
  usageLockouts: '{n} lockouts',
  usageGapsTitle: 'Searched for, found nothing',
  usageGapsIntro: 'Terms that returned no result. Each one names something the catalogue does not have, or a spelling it does not recognise.',
  usageGapsNone: 'Every search in the last 30 days returned something.',
  usageTerm: 'Search term',
  usageTimes: 'Times',
  usagePeopleCount: 'People',
  usagePopularTitle: 'Most opened',
  usagePopularNone: 'No records opened yet.',
  usageRecord: 'Record',
  usageOpened: 'Opened',
  usageToday: 'today',
  usageYesterday: 'yesterday',
  usageDaysAgo: '{n} days ago',
  usageNotTracked: 'Sign-ins, searches and records opened are recorded for each account so that problems can be found and fixed. This page shows how much each person used the tool, not a record of what they read.',
  sources: 'Sources',
  sourceLabel: 'Source',
  page: 'Page',
...
const HE = {
  ...
  acceptOwnEmailHint: 'בכתובת הזו תתחבר, ואליה יישלח איפוס סיסמה.',
  fullName: 'שם מלא',
  inviteByLink: 'צור קישור במקום',
  inviteByLinkHelp:
    'קישור בלי כתובת מייל, לשליחה ידנית. מי שפותח אותו מזין את השם והמייל שלו. הוא תקף לשימוש אחד, אז שלח אותו לאדם אחד.',
  inviteLinkCreated: 'נוצר קישור הזמנה',
  inviteLinkNote: 'תקף לשימוש אחד, על ידי מי שפותח ראשון. שלח לאדם אחד, לא לקבוצה.',
  ...
  passwordMinLength: 'יש להשתמש ב-{n} תווים לפחות.',
  signedInAs: 'מחובר כ-',
  ...
  recordFields: 'שדות הרשומה',
  usageTitle: 'שימוש',
  usageIntro: 'למי יש חשבון, מי חוזר להשתמש, ואיפה משתמשים נתקעים.',
  usageActiveAccounts: 'חשבונות פעילים',
  usageSignedIn7d: 'התחברו השבוע',
  usagePendingInvites: 'הזמנות שטרם נענו',
  usageNeverSignedIn: 'מעולם לא התחברו',
  usageLastFortnight: 'התחברויות, שבועיים אחרונים',
  usagePeople: 'משתמשים',
  usageName: 'משתמש',
  usageLastSeen: 'התחברות אחרונה',
  usageLastActive: 'פעילות אחרונה',
  usageSignIns30d: 'התחברויות',
  usageSearches30d: 'חיפושים',
  usageViews30d: 'תרופות שנפתחו',
  usageEmptySearches30d: 'ללא תוצאות',
  usageTrouble: 'תקלות',
  usageDevice: 'מכשיר',
  usageLast30d: '30 הימים האחרונים',
  usageFailedSignIns: '{n} התחברויות שנכשלו',
  usageLockouts: '{n} חסימות',
  usageGapsTitle: 'חיפושים שלא החזירו תוצאה',
  usageGapsIntro: 'מונחים שחיפשו ולא נמצאו. כל אחד מהם מצביע על תוכן שחסר בקטלוג, או על כתיב שהמערכת לא מזהה.',
  usageGapsNone: 'כל החיפושים ב-30 הימים האחרונים החזירו תוצאות.',
  usageTerm: 'מונח החיפוש',
  usageTimes: 'פעמים',
  usagePeopleCount: 'משתמשים',
  usagePopularTitle: 'התרופות שנפתחו הכי הרבה',
  usagePopularNone: 'עדיין לא נפתחו תרופות.',
  usageRecord: 'תרופה',
  usageOpened: 'נפתחה',
  usageToday: 'היום',
  usageYesterday: 'אתמול',
  usageDaysAgo: 'לפני {n} ימים',
  usageNotTracked: 'התחברויות, חיפושים ותרופות שנפתחו נרשמים לכל חשבון, כדי שנוכל לאתר תקלות ולתקן אותן. הדף הזה מציג כמה כל אחד השתמש בכלי, ולא רישום של מה שקרא.',
  sources: 'מקורות',
  sourceLabel: 'מקור',
  page: 'עמוד',
