...
const EN = {
  ...
  usageTitle: 'Usage',
  usageIntro: 'Who has an account, and who is coming back.',
  ...
  usageSignIns30d: 'Sign-ins (30d)',
  usageToday: 'today',
  usageYesterday: 'yesterday',
  usageDaysAgo: '{n} days ago',
  usageNotTracked: 'What anyone searched for or read is not recorded anywhere in this system, so it cannot be shown here.',
  sources: 'Sources',
  sourceLabel: 'Source',
  page: 'Page',
...
const HE = {
  ...
  usageTitle: 'שימוש',
  usageIntro: 'למי יש חשבון, ומי חוזר להשתמש.',
  ...
  usageSignIns30d: 'התחברויות (30 יום)',
  usageToday: 'היום',
  usageYesterday: 'אתמול',
  usageDaysAgo: 'לפני {n} ימים',
  usageNotTracked: 'מה שמישהו חיפש או קרא אינו נרשם בשום מקום במערכת, ולכן לא ניתן להציג אותו כאן.',
  sources: 'מקורות',
  sourceLabel: 'מקור',
  page: 'עמוד',
