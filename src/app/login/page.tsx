...
export default async function LoginPage({
  ...
  return (
    <div className="flex min-h-[70dvh] items-center justify-center">
      <div className="w-full max-w-sm space-y-5 rounded-2xl border border-[var(--color-line)] bg-[var(--color-surface)] p-7 text-center">
        <div>
          <h1 className="text-2xl font-semibold">Beitenu</h1>
          <p className="mt-1 text-sm text-[var(--color-muted)]">Our household, in one place.</p>
        </div>
        ...
        {configured ? (
          <>
            <a
              ...
              className="block w-full rounded-xl bg-[var(--color-accent)] px-4 py-2.5 text-sm font-medium text-white"
            >
          ...
          <div className="space-y-2 text-start text-sm text-[var(--color-muted)]">
            <p className="font-medium text-[var(--color-ink)]">Google sign-in isn&rsquo;t set up yet.</p>
            <p>
