...
export function DraftList({ drafts }: { drafts: Draft[] }) {
  ...
  return (
    <div className="space-y-3">
      {drafts.map((d) => (
        <div key={d.id} className="rounded-2xl border border-[var(--color-line)] bg-[var(--color-surface)] p-4">
          <button
          ...
          >
            ...
            <div className="mt-0.5 text-xs text-[var(--color-muted)]" dir="auto">
            ...
            <>
              ...
              <div className="mt-3 flex flex-wrap gap-2">
                {d.composeUrl && (
                  <a
                    href={d.composeUrl}
                    className="rounded-xl bg-[var(--color-accent)] px-3 py-1.5 text-sm font-medium text-white"
                  >
                    Open in mail
                  </a>
                )}
                ...
                <button
                  ...
                  disabled={busy}
                  className="rounded-xl border border-[var(--color-line)] px-3 py-1.5 text-sm text-[var(--color-muted)] disabled:opacity-40"
                >
                  Discard
                </button>
              </div>
