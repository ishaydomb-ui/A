...
# Measured on the 25-message sweep: median 18s, worst 74s. 60 covers the
# median comfortably and cuts the tail, which matters because this sits
# in the middle of a chain — see the worst-case arithmetic in nlu.py.
