...
- "תכנן לי שבוע" / "תפריט שבועי" => intent=meal_plan. גם ניסוח עקיף או שאלה —
  "מה נאכל השבוע?" / "מה עושים לארוחות ערב?" / "אין לי מושג מה לבשל השבוע" —
  הוא meal_plan. שאלה על אוכל לטווח של שבוע היא בקשה לתפריט, לא הודעה לא ברורה.
