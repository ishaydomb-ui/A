...
_PANTRY = ("אורז", "פסטה", "ספגטי", "קמח", "סוכר", "מלח", "שמן", "קטניות", "עדשים", "חומוס", "טחינה",
           ...
           "מלפפונים בחומץ", "מלפפון בחומץ", "קורנישונים", "כבוש", "כבושים", "פירורי", "ממרח", "מרק",
           "אבקת מרק", "סירופ", "קפה נמס", "שוקו", "ממרח שוקולד")
...
_FROZEN = ("קפוא", "קפואה", "קפואים", "קפואות", "מוקפא", "מוקפאים", "מוקפאות", "טבעפרוסט", "סנפרוסט",
           "בונדואל", "גלידה", "שלגון", "ארטיק", "בצק")
_SNACK = ("חטיף", "חטיפים", "במבה", "ביסלי", "שוקולד", "ממתק", "ממתקים", "עוגיות", "עוגיה", "וופל",
          ...
          "עוגה", "עוגות", "עוגת", "קרמבו", "שקדי מרק", "מאפינס", "מאפין")
